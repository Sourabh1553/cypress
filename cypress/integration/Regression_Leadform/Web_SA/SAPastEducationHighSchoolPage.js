describe('Regression- SA Education Preference Page', () => {
    ...
    it('Apply Now Btn- Verify past experience page with passport as No', () =>{
        cy.fixture('xpath').then((data)=>{
            cy.get(data.SA_applynow2).click()
            cy.WebRegressionSA_PastEdu_HighSchoolForm('web_VerifyPage_Passport-No')
        })
    }) 
    ...
    it('Apply Now Btn- Verify past experience page with passport as Yes', () =>{
        cy.fixture('xpath').then((data)=>{
            cy.get(data.SA_applynow2).click()
            cy.WebRegressionSA_PastEdu_HighSchoolForm('web_Passport-Yes')
        })
    }) 
})