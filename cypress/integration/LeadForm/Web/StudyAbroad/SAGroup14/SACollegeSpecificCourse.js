    describe('Study Abroad College-Course Page- Sanity', () => {
        beforeEach(() => {
        ...
        it('Btech Form- Check detailed fees', () => {
            cy.fixture('xpath').then((data)=>{
                cy.get(data.SA_checkdetails2_btn).click()
                cy.LeadForm('web_SA_btech')
            })
        })
        ...
        it('Btech Form- Get free counselling-2', () => {
            cy.fixture('xpath').then((data)=>{
                cy.get(data.SA_freecounselling1_btn).click()
                cy.LeadForm('web_SA_btech')
            })
        })

        it('Btech Form- Get fees details-2', () => {
            cy.fixture('xpath').then((data)=>{
                cy.get(data.SA_getfeedetails_btn).click()
                cy.LeadForm('web_SA_btech')
            })
        })
