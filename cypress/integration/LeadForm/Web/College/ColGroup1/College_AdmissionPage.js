    describe('College Admission Page- Sanity', () => {
        beforeEach(() => {
            ...
            cy.fixture('endpoint').then((data)=>{
                if(Cypress.env("varEnv")=='prod'){
                    ...
                    cy.visit(Cypress.env("prod")+'/14191-maharaja-agrasen-institute-of-technology-mait-new-delhi/admission')
                }else{
                    cy.log(Cypress.env("varEnv"))
                    cy.time('pageload')
        ...
        it('MBBS Form', () =>{
            cy.fixture('xpath').then((data1)=>{
                cy.get(data1.col_apply_now_btn).click()
